...
Download and extract [VibeWalkie-Companions-1.0.0.zip](https://github.com/ncleton/vibe-walkie/releases/download/companions-v1.0.0/VibeWalkie-Companions-1.0.0.zip) on the computer. Run the commands below from its extracted folder, which contains `Companion/`. The same package supports both systems.
